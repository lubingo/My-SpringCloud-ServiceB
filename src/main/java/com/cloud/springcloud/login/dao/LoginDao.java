...
public interface   LoginDao extends JpaRepository<Login,Integer> , JpaSpecificationExecutor<Integer> {
    ...
    public  Object  queryByIdAndToken(long  lId , String token);

    @Query(value = " SELECT  *  FROM   tb_login_user  WHERE  str_Email = ?1  ",nativeQuery = true)
    public  Object  existsByEmail(String  str_Email );
    ...
    public Login queryLoginBylIdAndPw(String str_Email ,String  str_Password);
