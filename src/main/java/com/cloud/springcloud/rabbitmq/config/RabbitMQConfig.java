...
public class RabbitMQConfig {
    ...
    public Queue directQueueFirst(){
        return  new Queue("DirectQueueFirst");
    }
    @Bean
    ...
    public Binding bindingQueueTopicExchange(Queue topicQueueFirst , TopicExchange topicExchannel){
        return BindingBuilder.bind(topicQueueFirst).to(topicExchannel).with("bindingKeyForTopicExchange");
    }
    ...
    public Queue  fanoutQueueFirst(){
        return  new Queue("FanoutQueueFirst" );
    }
    @Bean
